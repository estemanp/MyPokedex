                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    ScrollView {
                        LazyVGrid(columns: gridItems, spacing: 16) {
                            ForEach(Array(viewModel.pokemonList.enumerated()), id: \.element) { index, pokemon in
...
struct PokedexView_Previews: PreviewProvider {
    static var previews: some View {
        PokedexView(viewModel: MockPokedexViewModel(repository: PokemonDataRepository()))
    }
}
